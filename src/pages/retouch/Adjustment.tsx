...
export function Adjustment() {
    ...
    return (
        <Box>
            ...
            >
                <Tab label="亮度" value="brightness" />
                <Tab label="灰度" value="contrast" />
                <Tab label="饱和度" value="saturation" />
                <Tab label="噪点" value="noise" />
                <Tab label="做旧" value="sepia" />
                <Tab label="平衡饱和" value="vibrance" />
            </Tabs>
